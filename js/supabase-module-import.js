...
export async function analyzeModuleImport(projectId, modules) {
    const { data, error } = await supabase.functions.invoke('import-modules', {
        body: {
            action: 'analyze',
...
export async function executeModuleImport(projectId, modules, forceOverwrite = false) {
    const { data, error } = await supabase.functions.invoke('import-modules', {
        body: {
            action: 'execute',
            project_id: projectId,
...
export function parseModuleCSV(csvText) {
