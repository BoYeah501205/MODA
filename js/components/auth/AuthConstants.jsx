...
window.ALL_AVAILABLE_TABS = [
    ...
    { id: 'supplychain', label: 'Supply Chain', icon: 'icon-supply-chain', description: 'Material shortage tracking' },
...
window.DEFAULT_DASHBOARD_ROLES = [
    {
        ...
        tabPermissions: {
            ...
            supplychain: { canView: true, canEdit: true, canCreate: true, canDelete: true },
