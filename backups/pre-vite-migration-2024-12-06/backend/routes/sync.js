...
// POST /api/sync/import - Import data from localStorage export (FULL REPLACE)
router.post('/import', (req, res, next) => {
    try {
        ...
        db.transaction(() => {
            // FULL REPLACE: Clear existing data and re-import
            // This ensures localStorage is always the source of truth during sync
            db.run('DELETE FROM module_stage_progress');
            db.run('DELETE FROM module_difficulties');
